...
class AzureRMReplicationProtectionContainers(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("ReplicationProtectionContainer instance doesn't exist")
            ...
            self.log('ReplicationProtectionContainer instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the ReplicationProtectionContainer instance')
            ...
            self.log('ReplicationProtectionContainer instance deleted')
            self.results['changed'] = True
            ...
            self.log('ReplicationProtectionContainer instance unchanged')
    ...
    def create_update_resource(self):
        # self.log('Creating / Updating the ReplicationProtectionContainer instance {0}'.format(self.))
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("ReplicationProtectionContainer instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the ReplicationProtectionContainer instance.')
        if found is True:
            return response
