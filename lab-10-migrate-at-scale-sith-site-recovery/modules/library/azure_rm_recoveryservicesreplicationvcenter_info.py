...
DOCUMENTATION = '''
---
module: azure_rm_recoveryservicesreplicationvcenter_info
version_added: '2.9'
short_description: Get ReplicationvCenter info.
description:
  - Get info of ReplicationvCenter.
options:
  resource_name:
    description:
...
EXAMPLES = '''
- name: Gets the list of vCenter registered under the vault.
  azure_rm_recoveryservicesreplicationvcenter_info:
    resource_name: myVault
    resource_group: myResourceGroup
- name: Gets the list of vCenter registered under a fabric.
  azure_rm_recoveryservicesreplicationvcenter_info:
    resource_name: myVault
    resource_group: myResourceGroup
    fabric_name: myReplicationFabric
- name: Gets the details of a vCenter.
  azure_rm_recoveryservicesreplicationvcenter_info:
    resource_name: myVault
    resource_group: myResourceGroup
    fabric_name: myReplicationFabric
...
replicationv_centers:
  description: >-
    A list of dict results where the key is the name of the ReplicationvCenter
    and the values are the facts for that ReplicationvCenter.
  returned: always
  type: complex
  contains:
    replicationvcenter_name:
...
class AzureRMReplicationvCentersInfo(AzureRMModuleBase):
    def __init__(self):
        ...
        self.mgmt_client = None
        super(AzureRMReplicationvCentersInfo, self).__init__(self.module_arg_spec, supports_tags=True)
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.resource_name is not None and
            ...
            self.results['replicationv_centers'] = self.format_item(self.get())
        elif (self.resource_name is not None and
              self.resource_group is not None and
              self.fabric_name is not None):
            self.results['replicationv_centers'] = self.format_item(self.listbyreplicationfabrics())
        elif (self.resource_name is not None and
              self.resource_group is not None):
            self.results['replicationv_centers'] = self.format_item(self.list())
        return self.results
...
def main():
    AzureRMReplicationvCentersInfo()
