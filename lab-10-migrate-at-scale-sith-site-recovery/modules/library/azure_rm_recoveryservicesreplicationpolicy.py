...
class AzureRMReplicationPolicies(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("ReplicationPolicy instance doesn't exist")
            ...
            self.log('ReplicationPolicy instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the ReplicationPolicy instance')
            ...
            self.log('ReplicationPolicy instance deleted')
            self.results['changed'] = True
            ...
            self.log('ReplicationPolicy instance unchanged')
    ...
    def create_update_resource(self):
        # self.log('Creating / Updating the ReplicationPolicy instance {0}'.format(self.))
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("ReplicationPolicy instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the ReplicationPolicy instance.')
        if found is True:
            return response
