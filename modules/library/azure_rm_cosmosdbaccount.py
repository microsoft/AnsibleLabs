...
class AzureRMCosmosDBAccount(AzureRMModuleBase):
    ...
    def __init__(self):
        self.module_arg_spec = dict(
            ...
            enable_aggregation_pipeline=dict(
                type='bool'
            ),
    ...
    def exec_module(self, **kwargs):
        ...
        if self.parameters.pop('enable_aggregation_pipeline', False):
            self.parameters['capabilities'].append({'name': 'EnableAggregationPipeline'})
