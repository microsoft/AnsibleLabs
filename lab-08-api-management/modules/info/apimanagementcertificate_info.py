...
DOCUMENTATION = '''
---
module: apimanagementcertificate_info
version_added: '2.9'
...
- name: ApiManagementListCertificates
  azure.rm.apimanagementcertificate_info:
...
class AzureRMCertificateInfo(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.resource_group is not None and
            ...
            self.results['certificate'] = self.listbyservice()
        return self.results
    ...
    def get(self):
        ...
        self.url = self.url.replace('{{ certificate_name }}', self.certificate_id)
